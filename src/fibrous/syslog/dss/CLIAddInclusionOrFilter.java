...
public class CLIAddInclusionOrFilter extends FiCommand {
	...
	public CLIAddInclusionOrFilter(String commandString, FilterManager filterManager, GUIIOStream ios) {
		...
		this.commandDescription = "Adds a log message inclusion-or filter.  Usage: inc-or msg seq [filter name] \"sequence of characters\" \"sequence of characters\" ...";
	}
	...
	public void execute() {
		...
		SoffitObject s_filter = new SoffitObject("InclusionOr", arguments.get(0));
